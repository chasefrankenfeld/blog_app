...
RSpec.describe "Articles", type: :request do
  before do
    ...
    @fred = User.create(email: "fred@example.com", password: "fredpassword")
  ...
  describe "GET /articles/:id/edit" do
    ...
    context "with signed user as owner successful edit" do
      before do
        login_as(@john)
        get "/articles/#{@article.id}/edit"
      end
  ...
  describe 'GET /articles/:id' do
    ...
    context "with non-existing article" do
      ...
      it "handles non-existing article" do
        expect(response.status).to eq(302)  # HTTP response status code 302 Found is a common way of performing URL redirection
